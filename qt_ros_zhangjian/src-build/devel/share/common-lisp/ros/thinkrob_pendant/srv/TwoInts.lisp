...
(cl:in-package thinkrob_pendant-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name thinkrob_pendant-srv:<TwoInts-request> is deprecated: use thinkrob_pendant-srv:TwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <TwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader thinkrob_pendant-srv:a-val is deprecated.  Use thinkrob_pendant-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <TwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader thinkrob_pendant-srv:b-val is deprecated.  Use thinkrob_pendant-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TwoInts-request>)))
  ...
  "thinkrob_pendant/TwoIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TwoInts-request)))
  "Returns string type for a service object of type 'TwoInts-request"
  "thinkrob_pendant/TwoIntsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name thinkrob_pendant-srv:<TwoInts-response> is deprecated: use thinkrob_pendant-srv:TwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <TwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader thinkrob_pendant-srv:sum-val is deprecated.  Use thinkrob_pendant-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TwoInts-response>)))
  ...
  "thinkrob_pendant/TwoIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TwoInts-response)))
  "Returns string type for a service object of type 'TwoInts-response"
  "thinkrob_pendant/TwoIntsResponse")
